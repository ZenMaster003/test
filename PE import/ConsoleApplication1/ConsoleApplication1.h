int main(int argc, char * argv[]) {
	...
	// open file
	file = CreateFileA("C:\\Users\\mr\\Desktop\\New folder (4)\\psiphon3.exe", GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
	...
	for (; importDescriptor->Name != 0; importDescriptor++) {
		...
		const char* dllName = reinterpret_cast<const char*>(fileData + aa);
		printf("\t%s\n", static_cast<const char*>(dllName));
