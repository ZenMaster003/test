...
int main(int argc, char* argv[]) {
	...
	file = CreateFileA("D:\\chaii\\test PE\\psiphon3 - Copy - Copy.exe", GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
	...
	HANDLE outputFile = CreateFileA("D:\\chaii\\test PE\\output_pe.exe", GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
